...
CREATE TABLE Markalar(
 ...
 MID INT ,
 CONSTRAINT fkMusteriNo FOREIGN KEY(MID) REFERENCES Musteriler(MusteriID),
 U_ID INT ,
 CONSTRAINT fkUrunNo FOREIGN KEY(U_ID) REFERENCES Urunler(UrunID),
 SID INT,
 CONSTRAINT fkSatisNo FOREIGN KEY(SID) REFERENCES Satislar(SatisID),
);
GO
...
--Marka Ekleme--
INSERT INTO Markalar(MarkaAdi,MID,U_ID,SID) VALUES 
('LCW',2,1,3),
('Koton',2,4,3),
('Bershka',1,2,3),
('Zara',1,2,3),
